export const cards = {
  smallDeal: {
    ...
    preferredStock2: {
      ...
      name: "1GLOBE Oil",
      description:
        'Moderate yield, preferred shares of major international biotech company. Dividend and price fixed at "fair" level by state utility commission.',
      rule: "Everyone may buy or sell as many shares as they wish at this time.",
      symbol: "1GLO",
      dividend: 15,
      price: 1000,
    ...
    cd1: {
      ...
      description:
        "A leading bank offers this special Certificate of Deposit to its customer. Guaranteed interest and redeemable after any holding period.",
    ...
    companyS2: {
      ...
      name: "Start a Company Part Time",
      description:
        "Invent new way of making widgets, so you start a company to produce and sell them. No profits during startup, long hourse, no extra pay.",
      rule: "Use this yourself or sell to another player. 0% ROI, may sell for ??, if anything.",
      roi: 0,
      cost: 3000,
      downPayment: 3000,
  ...
  bigDeal: {
    ...
    realEstateB34: {
      ...
      type: "Real Estate",
      description:
        "5/4.5 house outside of metropolitan area offers potential capital gain plus current cash flow. Good rentals and nice financing.",
    ...
    realEstateB35: {
      ...
      type: "Real Estate",
      description:
        "6/6 house in exclusive hollywood neighborhood offers potential capital gain plus current cash flow. Good rentals and nice financing.",
  ...
  offer: {
    ...
    offer45: {
      ...
      description:
        "You are offered $17,000,000 for a 6/6 mansion. Buyer has own financing.",
      rule1: "Everyone may sell at this price",
      rule2:
        "If you sell, pay off the related mortgage and give up the cash flow you currently receive on this property.",
      offer: 17000000,
    ...
    offer46: {
      ...
      description:
        "You are offered $1,800,000 for a 5/4 mansion. Buyer has own financing.",
      rule1: "Everyone may sell at this price",
      rule2:
        "If you sell, pay off the related mortgage and give up the cash flow you currently receive on this property.",
      offer: 1800000,
